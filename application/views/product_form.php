...
<head>
    ...
    <script type="text/javascript">
        ...
        Stripe.setPublishableKey('pk_test_51HTS4nAqlcehBW2HueQvgCE3HFxFTQxa83naRf7Q3iEjVQvAFhBykADhx8IS5jKURbpdZgIGF4eHnP04PZ1IzLpo00kcpv3RMB');
...
<body>
       <a class="navbar-brand btn btn-danger "  style=" margin-top: 20px; margin-left: 20px;" href="<?=  base_url('users/index'); ?>">Home</a> 

<h1><center><font color="violet">Stripe payment gateway integration in codeigniter By Shahebaaz_Sn</font></center></h1>
