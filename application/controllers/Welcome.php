...
class Welcome extends CI_Controller {
	...
	public function check()
	{
		...
		if(!empty($_POST['stripeToken']))
		{
			...
			//set api key
			$stripe = array(
         "secret_key"      => "sk_test_51HTS4nAqlcehBW2Hl5Zb9i39suZP5IoFEVLvTVJNAww10ong4S9UNPZHPGQwoZKcvrgHFUfnBrhHFnqK5muzqKfB00eSf2RoKI",
		"publishable_key" => "pk_test_51HTS4nAqlcehBW2HueQvgCE3HFxFTQxa83naRf7Q3iEjVQvAFhBykADhx8IS5jKURbpdZgIGF4eHnP04PZ1IzLpo00kcpv3RMB"
			);
